...
--Admin user
INSERT INTO users(username,password,enabled) VALUES ('admin1','$2a$10$B4srWD5ejof0cIiI1CsvseKsIbg01bc9L/40aduSxL9vdKp1fSHKO',TRUE);
INSERT INTO authorities(id,username,authority) VALUES (3,'admin1','admin');
INSERT INTO portfolio(id, sobre_mi) VALUES (3, 'Soy un administrador con todas las funcionalidades activas.');
INSERT INTO beavers(id, first_name, last_name, dni, email, url_foto_perfil, valoracion, portfolio_id, username) VALUES (3, 'Nombre', 'Apellidos', '92234321Q', 'adminprueba@email.com', 'https://cdn.pixabay.com/photo/2013/07/13/13/38/man-161282_960_720.png', 4.5, 3 , 'admin1');
