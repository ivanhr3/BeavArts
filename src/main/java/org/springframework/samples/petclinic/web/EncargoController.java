...
public class EncargoController {
	...
	public String processCreationForm(@PathVariable("beaverId") final int beaverId, @Valid final Encargo encargo, final BindingResult result, final ModelMap model) {
