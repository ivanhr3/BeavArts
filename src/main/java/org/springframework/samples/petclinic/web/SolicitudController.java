...
public class SolicitudController {
    ...
    public String crearSolicitudInit(@PathVariable("engId") int encargoId, final ModelMap model){
    ...
    public String crearSolicitud(@PathVariable("engId") int encargoId, final BindingResult result, @Valid final Solicitud solicitud, final ModelMap model){
        Encargo encargo = encargoService.findEncargoById(encargoId);
