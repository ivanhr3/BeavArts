...
public class SolicitudController {
	...
	public String acceptSolicitud(final Map<String, Object> model, @PathVariable("solId") final int solId) {
		...
		if (beaverId != encargo.getBeaver().getId()) {
			return SolicitudController.VISTA_DE_ERROR; //TODO: Front: Poned las redirecciones
		} else {
			...
			return SolicitudController.SOLICITUD_DETAILS; //TODO: Front: Poned las redirecciones
		}
	}
