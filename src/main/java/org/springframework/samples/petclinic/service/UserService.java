...
public class UserService {
	...
	public void sendConfirmationEmail(String userMail, String token){
		...
		mailMessage.setText("Gracias por registrarse en Beavarts, por favor acceda la siguiente URL para activar su cuenta." + "https://beavarts-4.herokuapp.com/confirmar?token=" + token);
