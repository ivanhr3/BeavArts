...
<div class="encCard text-center" style="margin-bottom: 10%;">
	...
	<c:choose>
		<c:when test="${not empty beaver.urlFotoPerfil}">
			<img  width="150px" height="150px" src="${beaver.urlFotoPerfil}" alt="" class="rounded-circle sombraPng" width="150">
		</c:when>
		<c:when test="${empty beaver.urlFotoPerfil}">
			<img  width="150px" height="150px" src="/resources/images/FotoBasePerfil.png" alt="" class="rounded-circle sombraPng" width="150">
		</c:when>
	</c:choose>
